...
/**
 * link https://www.jianshu.com/p/29f95efaa88b
 *
 * @author 【LYH】（【罗玉华】luoyuhua@lingxing.com）
 * @date 2023/03/14 11:22
 **/
public class GT {
...
//"Mozilla/5.0 (Macintosh; Intel Mac OS X 10_12_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/60.0.3112.113 Safari/537.36";
    ...
    public String translateText(String text, String sourceLang, String targetLang) throws Exception {
        ...
        String retStr = "";
        if (!(this.isSupport(sourceLang) || this.isSupport(targetLang))) {
...
//        String finalPath=PATH +"?client="+CLIENT+"&sl="+sourceLang+"&tl="+targetLang+"&dt=t&q="+ text ;
        ...
        String resp = this.postHttp(PATH, nvps);
        if (null == resp) {
